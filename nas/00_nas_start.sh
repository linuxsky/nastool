...
docker() {
	rm -rf ./sh/04_docker.sh && rm -rf ./sh/04_docker2.sh && wget https://wuzhuwei.work/upload/sh/nas/04_docker.sh && wget https://wuzhuwei.work/upload/sh/nas/04_docker2.sh && chmod 777 ./sh/04_docker.sh && chmod 777 ./sh/04_docker2.sh && bash ./sh/04_docker.sh
}
#5.核显ls /dev/dri
hexian() {
yellow "检查是否正确驱动核显。"
