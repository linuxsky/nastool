...
installdocker() {
    rm -rf ./centos7installdocker.sh && wget https://wuzhuwei.work/upload/sh/centos/centos7installdocker.sh && chmod 777 ./centos7installdocker.sh && ./centos7installdocker.sh ; rm -rf ./centos7installdocker.sh
}
#5.更改root用户密码为Aa123456，开放ssh远程访问
installssh() {
    rm -rf ./centos7tossh.sh && wget https://wuzhuwei.work/upload/sh/centos/centos7tossh.sh && chmod 777 ./centos7tossh.sh && ./centos7tossh.sh ; rm -rf ./centos7tossh.sh
}
#6.检查/开启/关闭指定端口
portone() {
    rm -rf ./portone.sh && wget https://wuzhuwei.work/upload/sh/centos/portone.sh && chmod 777 ./portone.sh && bash ./portone.sh ; rm -rf ./portone.sh
}
#7.关闭防火墙
fanghuoqiang() {
    rm -rf ./07_fanghuoqiang.sh && wget https://wuzhuwei.work/upload/sh/centos/07_fanghuoqiang.sh && chmod 777 ./07_fanghuoqiang.sh && ./07_fanghuoqiang.sh ; rm -rf ./07_fanghuoqiang.sh
}
#99.删除所有docker容器和镜像
rm_images_container() {
